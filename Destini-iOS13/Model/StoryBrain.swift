...
struct StoryBrain {
    ...
    mutating func nextStory(userChoice: String) {
        let storyNumber = story[currentStory]
        
        if userChoice == storyNumber.choice1 {
            currentStory = storyNumber.choice1Destination
        } else {
            currentStory = storyNumber.choice2Destination
        }
    }
}
